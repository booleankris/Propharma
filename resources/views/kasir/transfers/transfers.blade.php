                    ...
                    <div class="flex items-center justify-between px-5 py-3.5 bg-slate-50 border-b border-slate-100">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <a href="{{ route('transfers.print', $transfer->id) }}" target="_blank"
                                class="inline-flex items-center gap-1 px-3 py-1 bg-white border border-slate-200 hover:bg-slate-50 text-slate-600 text-[11px] font-semibold rounded-lg transition shadow-sm ml-2">
