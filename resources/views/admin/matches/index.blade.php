...
@section('title', 'Data Pertandingan Hari:  '. $matchDay->day)
...
@section('content')
    <section class="section">
        <div class="section-header">
            ...
            <h1>Data Match Hari: {{ $matchDay->day }} | {{ $matchDay->date }}</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="#">Matchday</a></div>
                <div class="breadcrumb-item"><a href="#">Matches</a></div>
                <div class="breadcrumb-item"><a href="#">index</a></div>
            </div>
                <div class="section-header-button ml-auto">
                    <a class="btn btn-primary" href="{{ route('matchday.matches.create', [$matchDay->id]) }}">
                        Tambah Match
                    </a>
                </div>
        </div>
...
@section('scripts')
    ...
    $(function() {
        ...
        tableData = $('#table-data').DataTable({
            ...
            pageLength: 10,
            ajax: {
                url: '{{ route('matchday.matches.index', $matchDay->id) }}',
                data: function(f) {
                    f.name  = $('#name').val();
            ...
            columns: [
                ...
                { data: 'home_team.name', name: 'team_home', orderable: false, searchable: false},
                { data: 'away_team.name', name: 'team_away' },
                { data: 'time', name: 'time' },
