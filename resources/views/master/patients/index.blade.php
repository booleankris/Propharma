            ...
            <div class="flex flex-col lg:flex-row gap-4">
                ...
                <div class="card w-full md:w-[65%] shadow-md rounded-2xl p-6 bg-white">
                    <div class="flex items-center mb-6">
                        ...
                        <h2 class="text-2xl font-bold text-gray-800 drop-shadow-sm">Data Patients</h2>
                    </div>
                ...
                <div class="bg-white p-6 rounded-2xl shadow-md w-full md:w-[35%] mx-auto">
                    <form id="patientForm" action="{{ route('patients.store') }}" method="POST" class="space-y-2">
                        @csrf
                        ...
                        <div>
                            <label class="block text-[14px] font-semibold text-gray-800 mb-1">Birth Date</label>
    ...
    <script>
        ...
        $(function() {
            ...
            $('#table-data tbody').on('click', 'tr', function() {
                ...
                $('#patient_id').val(selectedData.id);
            ...
            $('#deleteData').click(function() {
                ...
                if (!id) {
                    return iziToast.warning({
                        title: 'Warning',
                        message: 'Select a patient to delete.'
                    });
                }

                swal({
                    title: 'Delete?',
                    text: 'This patient will be removed permanently.',
                    icon: 'warning',
                    buttons: true,
                    dangerMode: true,
                }).then(function(yes) {
                    ...
                    $.ajax({
                        ...
                        success: function(res) {
                            iziToast.success({
                                title: 'Deleted',
                                message: res.message || 'Patient removed.',
                            });
