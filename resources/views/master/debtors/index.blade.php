            ...
            <div class="flex flex-col lg:flex-row gap-4">
                ...
                <div class="card w-full md:w-[65%] shadow-md rounded-2xl p-6 bg-white">
                    <div class="flex items-center mb-6">
                        ...
                        <h2 class="text-2xl font-bold text-gray-800 tracking-wide drop-shadow-sm">Data Debitur</h2>
                    </div>
                ...
                <div class="bg-white p-6 rounded-2xl shadow-md w-full md:w-[35%] mx-auto">
                    <form id="debtorForm" action="{{ route('debtors.store') }}" method="POST" class="space-y-2">
                        @csrf
                        <input type="hidden" id="debtor_id" name="id">
                        ...
                        <div>
                            <label class="block text-[14px] font-semibold text-gray-800 mb-1">Address</label>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
                            <div>
                                <label class="block text-[14px] font-semibold text-gray-800 mb-1">City</label>
                        ...
                        <div>
                            <label class="block text-[14px] font-semibold text-gray-800 mb-1">Email</label>
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            $('#deleteData').on('click', function() {
                ...
                swal({
                    title: 'Are you sure?',
                    text: 'This will delete the selected debtor.',
                    icon: 'warning',
                    buttons: true,
                    dangerMode: true,
                }).then((willDelete) => {
        ...
        function handleSubmit() {
            ...
            const id = document.getElementById('debtor_id').value;
            const url = id ? `/debtors/${id}` : form.action;
            ...
            axios({
                ...
                .then(response => {
                    ...
                    if (res.success) {
                        iziToast.success({
                            title: 'Berhasil!',
                            message: res.message || 'Data debitur berhasil disimpan.',
                            position: 'topRight',
                        });
                        form.reset();
                        $('#debtor_id').val('');
                        if (typeof tableData !== 'undefined') tableData.ajax.reload(null, false);
                    } else {
                        iziToast.error({
                            title: 'Gagal!',
                ...
                .catch(error => {
                    let message = 'Gagal mengirim data ke server.';
