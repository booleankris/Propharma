...
@section('title', 'Tambah Data Official'. $team->name)
...
<section class="section">
    <div class="section-header">
        ...
        <h1>Tambah Data Official {{ $team->name }}</h1>
    ...
    <div class="section-body">
        <div class="row">
            <div class="col-12">
                ...
                {!! Form::open(['method'=>'POST', 'route' => ['teams.squadofficials.store', $team->id], 'autocomplete'=>'off', 'class'=> 'needs-validation', 'novalidate'=> '', 'files' => true]) !!}
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label for="information" class="col-sm-3 col-form-label">
                                Keterangan
                                <i class="text-danger">*</i>
                            </label>
                            <div class="col-sm-9">
                                {!! Form::text('information', null, array('id' => 'information', 'placeholder' => 'Keterangan', 'class' => 'form-control', 'required')) !!}
                            </div>
                        </div>
