...
use App\Exports\Report\SalesReturExport;
...
class ProcessSalesReturExport implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $fileName = 'Laporan_Retur_Penjualan_' . $safeName . '_' . date('Ymd_His') . '.xlsx';
        ...
        try {
            ...
            Excel::store(
                new SalesReturExport($this->pharmacyId, $this->startDate, $this->endDate),
                $path,
                'public'
            );
            ...
            Log::error("Sales Retur Export Failed: " . $e->getMessage());
        }
    }
}
