    ...
    <div class="section-body">
        <div class="row">
            <div class="col-12">
                ...
                {!! Form::open(['method'=>'POST', 'route' => 'videos.store', 'autocomplete'=>'off', 'class'=> 'needs-validation', 'novalidate'=> '', 'files' => true]) !!}
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <iframe width="560" id="youtube" height="315" src="" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                            </div>
                        </div>
