...
<style>
    * { box-sizing: border-box; }
    ...
    .shell { min-height: 100vh; background: #f0f2f5; padding: 28px 20px; }
    .card  { margin: 0 auto; background: #fff; border-radius: 18px;
             box-shadow: 0 2px 16px rgba(0,0,0,.07); overflow: hidden; }

    /* Header */
    .card-header { background: #0f172a; padding: 22px 28px;
                   display: flex; align-items: center; gap: 14px; }
    .header-icon { width: 38px; height: 38px; background: rgba(59,130,246,.2);
                   border-radius: 10px; display: flex; align-items: center;
                   justify-content: center; flex-shrink: 0; }
    .card-header h1 { color: #f8fafc; font-size: 15px; font-weight: 600; margin: 0; }
    .card-header span { font-family: 'DM Mono', monospace; font-size: 12px;
                        color: #64748b; margin-top: 2px; display: block; }

    /* Tabs */
    .tabs { display: flex; border-bottom: 1px solid #f1f5f9; background: #fff; }
    .tab-btn { flex: 1; padding: 14px 10px; font-size: 13px; font-weight: 500;
               color: #94a3b8; background: none; border: none; cursor: pointer;
               border-bottom: 2px solid transparent; transition: all .15s;
               display: flex; align-items: center; justify-content: center; gap: 7px; }
    .tab-btn:hover { color: #475569; }
    .tab-btn.active { color: #0f172a; border-bottom-color: #0f172a; font-weight: 600; }
    .tab-badge { font-size: 10px; font-weight: 700; padding: 2px 7px;
    ...
    .badge-denied   { background: #fff1f1; color: #ef4444; }
    ...
    /* Flash */
    .alert { padding: 12px 28px; font-size: 13px; }
    .alert-success { background: #f0fdf4; color: #16a34a; border-left: 3px solid #16a34a; }
    .alert-danger  { background: #fff1f1; color: #ef4444; border-left: 3px solid #ef4444; }

    /* Transfer row */
    .transfer-row { padding: 16px 28px; border-bottom: 1px solid #f1f5f9;
    ...
    .tr-code { font-family: 'DM Mono', monospace; font-size: 11px;
               color: #64748b; background: #f1f5f9; padding: 2px 8px;
               border-radius: 5px; display: inline-block; margin-bottom: 5px; }
    .tr-name { font-size: 14px; font-weight: 600; color: #1e293b;
               white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
    .tr-meta { font-size: 12px; color: #94a3b8; margin-top: 3px; }

    .tr-stock { display: inline-flex; align-items: center; gap: 4px;
    ...
    .status-pill { font-size: 11px; font-weight: 600; padding: 3px 10px;
                   border-radius: 99px; flex-shrink: 0; }
    .pill-accepted { background: #f0fdf4; color: #16a34a; }
    .pill-denied   { background: #fff1f1; color: #ef4444; }

    /* Action buttons */
    .tr-actions { display: flex; gap: 8px; flex-shrink: 0; }
    ...
    .btn-deny { background: #fff; color: #ef4444; border: 1.5px solid #fecaca; }
    .btn-deny:hover { background: #fff1f1; }

    /* Empty state */
    .empty-state { padding: 48px 28px; text-align: center; color: #94a3b8; font-size: 13px; }
    .empty-state svg { margin-bottom: 12px; opacity: .35; }

    /* ── Detail Modal ── */
    .modal-overlay { display: none; position: fixed; inset: 0; z-index: 99999;
                     align-items: center; justify-content: center;
                     background: rgba(0,0,0,.45); }
    .modal-overlay.open { display: flex; }
    .modal-box { position: relative; background: #fff; border-radius: 18px;
    ...
    .modal-header { background: #0f172a; padding: 18px 22px;
                    display: flex; align-items: center; justify-content: space-between; }
    .modal-header h3 { color: #f8fafc; font-size: 14px; font-weight: 600; margin: 0; }
    .modal-header .modal-code { font-family: 'DM Mono', monospace; font-size: 11px; color: #64748b; }
    ...
    .detail-section-label { font-size: 10px; font-weight: 700; color: #94a3b8;
    ...
    .detail-item { background: #f8fafc; border: 1px solid #e2e8f0;
                   border-radius: 10px; padding: 10px 12px; }
    .detail-item .lbl { font-size: 10px; color: #94a3b8; font-weight: 600;
                        text-transform: uppercase; letter-spacing: .05em; margin-bottom: 4px; }
    .detail-item .val { font-size: 13px; color: #1e293b; font-weight: 500;
                        font-family: 'DM Mono', monospace; }
    .detail-item .val.green { color: #16a34a; }
    .detail-item.full { grid-column: span 2; }

    .modal-status { display: inline-flex; align-items: center; gap: 6px;
...
<div class="card">
    ...
    <div id="tab-accepted" class="tab-panel">
        ...
        <div class="transfer-row" onclick="openDetail({{ $t->id }})">
            ...
            <div class="tr-stock">{{ $t->stock }}</div>
            <span class="status-pill pill-accepted">✓ Diterima</span>
        </div>
        @empty
        <div class="empty-state">
            <svg width="38" height="38" viewBox="0 0 24 24" fill="none"
