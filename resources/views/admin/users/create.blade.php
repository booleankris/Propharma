    ...
    <div class="section-body">
        <div class="row">
            <div class="col-12">
                ...
                {!! Form::open(['method'=>'POST', 'route' => 'users.store', 'autocomplete'=>'off', 'class'=> 'needs-validation', 'novalidate'=> '']) !!}
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                {!! Form::text('name', null, array('id' => 'name', 'placeholder' => 'Nama Lengkap', 'class' => 'form-control', 'required', 'autofocus')) !!}
                            </div>
                        </div>
