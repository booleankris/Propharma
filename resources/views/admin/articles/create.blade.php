    ...
    <div class="section-body">
        <div class="row">
            <div class="col-12">
                ...
                {!! Form::open(['method'=>'POST', 'route' => 'articles.store', 'autocomplete'=>'off', 'class'=> 'needs-validation', 'novalidate'=> '', 'files' => true]) !!}
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="file" name="image" class="dropify" data-height="150" data-max-file-size="1M" data-allowed-file-extensions="jpg jpeg png" required>
                                <span class="text-muted">Maks. ukuran file 1 MB | Ekstensi png, jpg, jpeg</span>
                            </div>
                        </div>

                        <div class="form-group row">
                            <label for="image_info" class="col-sm-3 col-form-label">Deskripsi Thumbnail</label>
                            <div class="col-sm-9">
                                {!! Form::text('image_info', null, array('id' => 'image_info', 'placeholder' => 'Deskripsi Artikel', 'class' => 'form-control')) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea name="content" class="summernote-id" required></textarea>
                            </div>
                        </div>
