        ...
        <div class="section-body">
            ...
            <div class="mb-6 bg-white p-4 rounded-2xl shadow-sm border border-gray-100 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    ...
                    <div>
                        <div class="flex items-center gap-2">
                            <span class="text-xs font-bold uppercase tracking-wider text-gray-400">
                                {{ $canSwitch ? 'Pilih Cabang / Apotek' : 'Cabang / Apotek' }}
                            </span>
                        ...
                        <p class="text-xs text-gray-500 mt-0.5">
                            {{ $canSwitch ? 'Daftar obat wajib lapor dan stok pelaporan dihitung per masing-masing cabang.' : 'Menampilkan daftar obat wajib lapor dan stok pelaporan untuk cabang Anda.' }}
                        </p>
                    </div>
                </div>
                <div class="w-full sm:w-72">
                    ...
                    @else
                        <div class="w-full px-3.5 py-2.5 text-xs font-semibold rounded-xl border border-gray-200 bg-gray-50 text-gray-700 flex items-center justify-between shadow-xs">
                            <div class="flex items-center gap-2">
                                <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/></svg>
                                <span>{{ $pharmacies->firstWhere('id', $selectedPharmacyId)->name ?? 'Cabang Anda' }}</span>
                            </div>
                            <span class="text-[10px] uppercase font-bold text-gray-400 bg-gray-200 px-1.5 py-0.5 rounded">Terkunci</span>
                        </div>
                        <input type="hidden" id="branchSelector" value="{{ $selectedPharmacyId }}">
                    @endif
                </div>
            </div>
            ...
            12 => 'Desember',
                                ...
                                <div>
                                    ...
                                    @else
                                        <div class="w-full px-3 py-2 text-xs font-semibold rounded-xl border border-gray-200 bg-gray-50 text-gray-600 flex items-center justify-between">
                                            <span>{{ $pharmacies->firstWhere('id', $selectedPharmacyId)->name ?? 'Cabang Anda' }}</span>
                                        ...
                                        <input type="hidden" name="pharmacy_id" id="exportPharmacy" value="{{ $selectedPharmacyId }}">
                                    @endif
                                </div>
                            </div>
