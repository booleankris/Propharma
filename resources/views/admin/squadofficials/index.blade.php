...
@section('title', 'Data Tim '. $team->id)
        ...
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="section-header-button ml-auto">
                    <a class="btn btn-primary" href="{{ route('teams.squadofficials.create', [$team->id]) }}">
                        Tambah Data Ofc
                    </a>
                </div>
        </div>
...
@section('scripts')
    ...
    $(function() {
        ...
        tableData = $('#table-data').DataTable({
            ...
            pageLength: 10,
            ajax: {
                url: '{{ route('teams.squadofficials.index', $team->id) }}',
                data: function(f) {
                    f.name  = $('#name').val();
