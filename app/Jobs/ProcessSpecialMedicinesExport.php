...
use App\Exports\Report\SpecialMedicinesExport;
...
class ProcessSpecialMedicinesExport implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $fileName = 'SIPNAP_Narkotika_Psikotropika_' . $safeName . '_' . date('Ymd_His') . '.xlsx';
        ...
        try {
            ...
            Excel::store(
                new SpecialMedicinesExport($this->pharmacyId, $this->startDate, $this->endDate),
                $path,
                'public'
            );
            ...
            Log::error("Special Medicines Export Failed: " . $e->getMessage());
        }
    }
}
