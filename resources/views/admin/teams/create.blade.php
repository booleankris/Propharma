    ...
    <div class="section-body">
        <div class="row">
            <div class="col-12">
                ...
                {!! Form::open(['method'=>'POST', 'route' => 'teams.store', 'autocomplete'=>'off', 'class'=> 'needs-validation', 'novalidate'=> '', 'files' => true]) !!}
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label for="image" class="col-sm-3 col-form-label">Logo Tim</label>
                            <div class="col-sm-9">
                                <input type="file" name="image" class="dropify" data-height="150" data-max-file-size="1M" data-allowed-file-extensions="jpg jpeg png" accept="image/*">
