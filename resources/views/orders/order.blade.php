    ...
    <div id="smartOrderModal" class="fixed inset-0 z-[9999] hidden">
        ...
        <div
            ...
            <div class="px-6 py-3.5 bg-white border-b border-gray-100 flex flex-wrap items-center gap-3">
                ...
                <!-- Export Button -->
                <button type="button" onclick="exportSmartOrder()" id="smartBtnExport" title="Export Excel sesuai filter saat ini"
                    class="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-700 active:scale-95 text-white text-xs font-bold shadow-sm shadow-emerald-500/20 transition-all focus:outline-none focus:ring-2 focus:ring-emerald-500 shrink-0">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex items-center justify-between border-t border-gray-200 px-6 py-3.5 bg-slate-50/80">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <button type="button" onclick="exportSmartOrder()" id="smartBtnExportFooter"
                        class="inline-flex items-center gap-1.5 rounded-xl border border-emerald-300 bg-emerald-50 px-4 py-2 text-xs font-bold text-emerald-700 shadow-sm transition hover:bg-emerald-100 hover:border-emerald-400 focus:outline-none focus:ring-2 focus:ring-emerald-500">
...
@section('scripts')
    ...
    <script>
        ...
        function exportSmartOrder() {
            ...
            const btnExport1 = document.getElementById('smartBtnExport');
            const btnExport2 = document.getElementById('smartBtnExportFooter');
            const btns = [btnExport1, btnExport2].filter(Boolean);
            ...
            const downloadUrl = `{{ route('orders.smartMedicines.export') }}?${params.toString()}`;
