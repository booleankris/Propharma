                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label for="password" class="col-sm-3 col-form-label font-weight-bold">Password Baru</label>
                                <div class="col-sm-9">
                                    ...
                                    <small class="form-text text-muted">Biarkan kosong jika tidak ingin mengganti password/PIN.</small>
                                    @error('password')
                            ...
                            <div class="form-group row">
                                <label for="confirm-password" class="col-sm-3 col-form-label font-weight-bold">Konfirmasi Password Baru</label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    {!! Form::select('roles[]', $roles, $userRole, [
                                        'id' => 'roles',
                                        'class' => 'form-control custom-select select2 ' . ($errors->has('roles') ? 'is-invalid' : ''),
                                        'multiple',
                                        'required',
                                    ]) !!}
                                    @error('roles')
                        ...
                        <div class="card-footer text-right">
                            ...
                            <button type="submit" class="btn btn-lg btn-primary"><i class="fas fa-save mr-1"></i> Update</button>
                        </div>
                    </div>
                    {!! Form::close() !!}
